...
mineral salts from the earth available to the plant for various
metabolic processes. There are three types of roots i.e.
Tap Root, Adventitious Roots, and Lateral Root. The roots arise
from the parts of the plant and not from the rhizomes roots.`,
       `Stem is the posterior part that remainns above the ground and
grows negatively geotropic. Internodes and nodes are found on
the stem. Branch, bud, lead, petiole, flower, and inflorescence
on a node are all those parts of the plant that remain above the
